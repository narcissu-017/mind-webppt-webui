...
```bash
npx skills add narcissu-017/mind-webppt-webui --skill mindmap-ppt-builder
```

也可以直接把本仓库链接发给 Codex，并用自然语言说明：

```text
请帮我安装这个仓库里的 mindmap-ppt-builder Skill：
https://github.com/narcissu-017/mind-webppt-webui
```
